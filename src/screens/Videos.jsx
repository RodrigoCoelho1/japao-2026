...
const VIDEOS = [
  ...
  { id: 'YAlaZ9QtUcE', title: 'Como visitar o Monte Fuji — saindo de Tokyo', channel: 'Vai com Bruno', lang: '🇧🇷', tags: ['Tóquio', 'Geral'], desc: 'Como fazer o bate-volta ao Monte Fuji saindo de Tóquio: opções de trem, ônibus e pontos de observação.' },
